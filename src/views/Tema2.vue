      ...
      .row.justify-content-center.LnrGrad01.m-0
        .multi-collapse1.col-lg-10.collapse.show(data-bs-parent='#MapaGroup01')
          ...
          .bg-white.BRcardTOP.my-4
            ...
            .video
              iframe(width="560" height="315" src="https://www.youtube.com/embed/-mw6Wxh1Dc8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
        ...
        .multi-collapse2.col-lg-10.collapse(data-bs-parent='#MapaGroup01')
          ...
          .bg-white.BRcardTOP.my-4
            ...
            .video
              iframe(width="560" height="315" src="https://www.youtube.com/embed/Gi8_XDCFh-w" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
        ...
        .multi-collapse3.col-lg-10.collapse(data-bs-parent='#MapaGroup01')
          ...
          .bg-white.BRcardTOP.my-4
            ...
            .video
              iframe(width="560" height="315" src="https://www.youtube.com/embed/Qn8V2KnbQe0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
        ...
        .multi-collapse4.col-lg-10.collapse(data-bs-parent='#MapaGroup01')
          ...
          .bg-white.BRcardTOP.my-4
            ...
            .video
              iframe(width="560" height="315" src="https://www.youtube.com/embed/h1CQlb2tlP8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
        ...
        .multi-collapse5.col-lg-10.collapse(data-bs-parent='#MapaGroup01')
          ...
          .bg-white.BRcardTOP.my-4
            ...
            .video
              iframe(width="560" height="315" src="https://www.youtube.com/embed/m3Gj1uQk5H8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
